...
public class TagFriendActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listview.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,
                ...
                Intent i = new Intent();
                if(data.getName() != null && data.getUsername() != null) {
    ...
    private final BroadcastReceiver mNetworkReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (activeNetwork != null) { // connected to the internet
                ...
                AlertDialog.Builder alertDialog = new AlertDialog.Builder(TagFriendActivity.this);
                ...
                alertDialog.setPositiveButton("Settings", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        TagFriendActivity.this.startActivity(intent);
                    }
                });
    ...
    private void getInfo(){
        ...
        final ProgressDialog loading = ProgressDialog.show(TagFriendActivity.this, "Retrieving data...", "Please wait...", true, false);

        //Creating a string request
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.INFO_URL,
    ...
    private void showJSON(String response){
        String strName[], strUsername[], strGender[], strDateOfBirth[], strEmail[], strFoto[];
        actorsList.clear();
        ...
        try {
            ...
            strUsername = new String[result.length()];
            strGender = new String[result.length()];
            strDateOfBirth = new String[result.length()];
            strEmail = new String[result.length()];
            strFoto = new String[result.length()];

            for (int i = 0; i < result.length(); i++) {
                JSONObject data = result.getJSONObject(i);

                strName[i] = data.getString("nama");
                strUsername[i] = data.getString("username");
                strGender[i] = data.getString("jenisKelamin");
                strDateOfBirth[i] = data.getString("tanggalLahir");
                strEmail[i] = data.getString("email");
                strFoto[i] = data.getString("foto");
                Actors actor = new Actors();
                actor.setName(strName[i]);
                actor.setUsername(strUsername[i]);
                actor.setGender(strGender[i]);
                actor.setDate_of_birth(strDateOfBirth[i]);
                actor.setEmail(strEmail[i]);
