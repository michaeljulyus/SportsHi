...
public class MomentActivity extends AppCompatActivity {
    ...
    private TextView TextTagFriend;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextTagFriend = (TextView) findViewById(R.id.nameTag);
        TextLocation = (TextView) findViewById(R.id.location);
        TextCategory = (TextView) findViewById(R.id.sport);
        editTextStatus = (EditText) findViewById(R.id.txtStatusMsg);
        imageView = (ImageView) findViewById(R.id.imageMoment);
        ...
        TextTagFriend.setVisibility(View.GONE);
        TextLocation.setVisibility(View.GONE);
    }

    private void showFileChooser() {
        if (CheckPermission(MomentActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
            ...
            RequestPermission(MomentActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE, REQUEST_RUNTIME_PERMISSION);
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        switch(requestCode) {
            case (1): {
                ...
                String tempPath = getPath(selectedImageUri, MomentActivity.this);
            ...
            case (3): {
                if(data.getStringExtra("nama") != null && data.getStringExtra("username") != null) {
                    TextTagFriend.setVisibility(View.VISIBLE);
                    usernameTag = data.getStringExtra("username");
                    TextTagFriend.setText("with " + data.getStringExtra("nama"));
                }
            }
            break;
    ...
    private void postMoment() {
        ...
        if (bitmap != null) {
            moment = getStringImage(bitmap);
        } else {
            moment = "";
        }

        if (status.equals("") && bitmap == null)
            showAlertInformation();
        else {

            //Showing the progress dialog
            final ProgressDialog loading = ProgressDialog.show(this, "Posting...", "Please wait...", true, false);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, Config.MOMENT_URL,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            switch (response) {
                                case "Berhasil": {
                                    finish();
                                    Toast.makeText(MomentActivity.this, "Successfully sent the moment", Toast.LENGTH_LONG).show();
                                    break;
                                }
                                default:
                                    //Toast.makeText(MomentActivity.this, response, Toast.LENGTH_LONG).show();
                                    showAlertFailed();
                                    break;
                            }
                        }
                    ...
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            ...
                            //Showing toast
                            //Toast.makeText(MomentActivity.this, error.toString(), Toast.LENGTH_LONG).show();
                            showAlertInfo();
                        }
                    }) {
                @Override
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    params.put(Config.KEY_TAG_FRIEND_USERNAME, usernameTag);
                    params.put(Config.KEY_TAG_CATEGORY, category);
                    params.put(Config.KEY_TAG_LOCATION, location);
                    params.put(Config.KEY_STATUS, status);

                    //Adding parameters
                    params.put(Config.KEY_IMAGE, moment);
    ...
    public void showAlertInfo() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(MomentActivity.this);
    ...
    public void showAlertFail() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(MomentActivity.this);
        alertDialog.setTitle("Failed to Add Moment");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_category:
                Intent intentA = new Intent(MomentActivity.this, CategoryActivity.class);
                startActivityForResult(intentA, 5);
                return true;
            case R.id.action_tag:
                Intent intentB = new Intent(MomentActivity.this, TagFriendActivity.class);
                startActivityForResult(intentB, 3);
                return true;
